...
font_size = 90
# plt.text(0.22, 0.81, "Long-wave Radiation", fontsize=font_size, transform=fig.transFigure, ha="center")
# plt.text(0.415, 0.81, "Short-wave Radiation", fontsize=font_size, transform=fig.transFigure, ha="center")
# plt.text(0.61, 0.81, "Precipitation", fontsize=font_size, transform=fig.transFigure, ha="center")
# plt.text(0.805, 0.81, "Vapor Pressure Deficit", fontsize=font_size, transform=fig.transFigure, ha="center")
...
# plt.text(0.07, 0.72, "Net Radiation", fontsize=font_size, transform=fig.transFigure, ha="center")
# plt.text(0.07, 0.61, "Sensible Heat", fontsize=font_size, transform=fig.transFigure, ha="center")
# plt.text(0.06, 0.49, "Evapotranspiration", fontsize=font_size, transform=fig.transFigure, ha="center")
# plt.text(0.07, 0.37, "Surface \nSoil Moisture", fontsize=font_size, transform=fig.transFigure, ha="center")
# plt.text(0.07, 0.25, "Total Runoff", fontsize=font_size, transform=fig.transFigure, ha="center")
...
# subprocess.run(['/stu01/huangzl/software/miniconda3/bin/magick', input_file, '-trim', output_file])
