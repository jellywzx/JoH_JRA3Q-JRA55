...
for i, ax in enumerate(axs.flat):
    data1 = xr.open_dataset(f'{folder_path}/{var[i]}_ref_{ref_data[i]}_sim_JRA3Q_0.25_KGESS.nc')['KGESS']
...
plt.savefig('C:/Users/fzjxw/Desktop/study/BaiduSyncdisk/JRA3Q&JRA55/plot_code/FigS6_JRA-3Q_KGESS.jpg', format='jpg', dpi=300, bbox_inches='tight')
