...
for i, ax in enumerate(axs.flat):
    if i == 5:  # Streamflow scatter plot
        ...
        data1 = xr.open_dataset(
            f'{folder_path}/{var[i]}_ref_{ref_data[i]}_sim_JRA3Q_0.25_KGESS.nc')['KGESS']
...
plt.savefig(
    'C:/Users/fzjxw/Desktop/study/BaiduSyncdisk/JRA3Q&JRA55/plot_code/Fig5_JRA-3Q_KGESS.jpg', 
