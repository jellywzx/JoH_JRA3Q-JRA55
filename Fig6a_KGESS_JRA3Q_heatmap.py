...
for k in range(0, len(file_lists), 2):
    ...
    df1 = df
    kgess_diff_df.loc[var_name] = df1.values[0]
...
# 设置标题和布局
fig.text(0.15, 0.98, '(a)', fontsize=35, va='top', ha='left')
plt.suptitle('KGESS of JRA-3Q', fontsize=35, )
fig.subplots_adjust(hspace=0, left=0.15, right=0.85)

# 保存图像
plt.savefig('C:/Users/fzjxw/Desktop/Datacomparison/Glb_0.25_0317/output/metrics/IGBP_groupby/KGESS_JRA-3Q.jpg',
